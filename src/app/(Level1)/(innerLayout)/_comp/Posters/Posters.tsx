...
export default function Posters({POSTER, type}:{POSTER:any, type:string}) {
    ...
    if(type == "movie_serie"){
        ...
        languages = POSTER?.map((item:any) => item?.language);
        ...
        mapped_current = POSTER.map((item:any, index:number) => {
    ...
    <div className={styles.altTitle_Cont}>
        ...
        <div className={styles.left_nav_bar}>
            <div className={styles.fullcrum_nav}>
                <div style={{background: `${FTC?.DarkVibrant}`}} className={styles.fullcrum_head}>Posters</div>
